...
Throughout my final course, I worked on a capstone project wherein I enhanced some of my previous works to demonstrate the skills I've learned. I published these works in this ePortfolio. Throughout the project, I worked on three artifacts that demonstrate industry-important, valuable skills. Those projects are an encryption program, a vector sorting program, and a MySQL project. 

These artifacts were all originally created throughout my time as a student in the Computer Science program at Southern New Hampshire University. I've learned a lot over the past four years. Going into the Computer Science program, I had very little knowledge of the industry and how complex it can get. I had not written a line of code before entering the program. I had some IT knowledge, but it was not enough to prepare me for the exciting and evolving world of computer science that I had thrown myself into. I have grown much as a professional and as a student, and I truly believe that you should never stop learning. I will remain a "student" of computer science for the rest of my life, and I aim to continue learning and growing as the industry continues to evolve around and with me.

I chose these projects to enhance because they demonstrate my growth and attainment of important concepts. Specifically, the demonstrate my skills in software engineering and design, data structures and algorithms, and databases. Working on the enhancements to these works only further honed my skills and abilities. I employed strategies for building collaborative environments that enable diverse audiences to support organizational decision making in the field of computer science by completing the each of the enhancements, as I worked on creating comments and headers that allow and encourage other programmers to jump in and make their own additions. Similarly, I designed, developed and delivered professional-quality oral, written, and visual communications that are coherent, technically sound, and appropriately adapted to specific audiences and contexts through comments, the narratives, as well as the code review at the bottom of the page. Through my work on the encryption and vector sorting programs, both of which use algorithms and employ algorithmic and computing concepts like recursion and iteration, I designed and evaluated computing solutions that solve a given problem using algorithmic principles and computer science practices and standards appropriate to its solution, while managing the trade-offs involved in design choices. I demonstrated an ability to use well-founded and innovative techniques, skills, and tools in computing practices for the purpose of implementing computer solutions that deliver value and accomplish industry-specific goals through my databases project, wherein I used widely used real-world tools such as AWS and MySQL Workbench to create and query a database. Finally, my focus on encryption in my encryption artifact demonstrates that I have developed a security mindset that anticipates adversarial exploits in software architecture and designs to expose potential vulnerabilities, mitigate design flaws, and ensure privacy and enhanced security of data and resources.

Below, you will find screenshots/video of each project to illustrate what the programs do. You will also find a narrative accompanying each one detailing my process as I worked on them. Thirdly, you will find copies of the original and enhanced code to demonstrate the work that was done on them.
